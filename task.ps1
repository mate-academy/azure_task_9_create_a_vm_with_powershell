...
$pip = New-AzPublicIpAddress -Name $publicIpAddressName -ResourceGroupName $resourceGroupName -AllocationMethod Dynamic -DomainNameLabel $dnsPrefix -Location $location
